...
interface FilterStoreState {
    filters: FilterItem[];
    addFilterItem: (filterName: string, value: string, filterType: FilterType, filterKey: string) => void;
...
function removeFilterValue(filters: FilterItem[], filterName: string, value: string): FilterItem[] {
