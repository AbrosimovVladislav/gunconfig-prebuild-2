        ...
        <GCHeader height={70} className={classes.header} mb={120}>
            <div className={classes.inner}>
                <GCGroup>
                    ...
                    <GCLink href={"/"}><GCImage className={classes.logo} src="https://gunmarket.fra1.digitaloceanspaces.com/NFT_LOGO_REVOLVER.png" alt=""/></GCLink>
                    <GCLink href={"/"}>GunCraft</GCLink>
                </GCGroup>
