...
export const GCAccordion = ({className, children, showName, panel, size, ...props}: GCAccordionProps) => {
    const [value, setValue] = useState<string[]>([]);
    const {classes} = useStyles();
    return <Accordion multiple value={value} className={classes.filter} onChange={setValue} {...props}
